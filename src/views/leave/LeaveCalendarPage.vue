    ...
    >
      ...
      <section class="calendar-shell">
        ...
        >
          ...
          <div
            v-if="showSkeleton"
            class="section-skeleton-list"
          >
            <div
              v-for="i in 3"
              :key="`holiday-skeleton-${i}`"
              class="section-skeleton-card"
            >
              <AppSkeleton
                shape="squircle"
                width="52px"
            ...
            >
              <div class="date-badge holiday-badge">
                <span
                  class="day"
                  :class="{
                    'long-text': holiday.date.split(' ')[0].length > 2,
                  }"
                  >{{ holiday.date.split(' ')[0] }}</span
                >
                <span class="month">{{ holiday.date.split(' ')[1] }}</span>
              </div>
              <div class="leave-info">
                <h3 class="holiday-title-en">
                  {{ getEnglishName(holiday.type) }}
                </h3>
                <h4
                  v-if="getKhmerName(holiday.type)"
                  class="holiday-title-km"
                >
          ...
          >
            ...
            >
              ...
              >
                <span
                  class="day"
                  :class="{ 'long-text': leave.date.split(' ')[0].length > 2 }"
                  >{{ leave.date.split(' ')[0] }}</span
                >
...
import { useLeaveCalendarPage } from "@/composables/useLeaveCalendarPage";
